...
class RecordActivity : BaseActivity(), SurfaceHolder.Callback, Camera.PictureCallback   {
    ...
    private fun requestPermissions(permissions: Array<String?>) {
        ActivityCompat.requestPermissions(this@RecordActivity, permissions, REQUEST_CODE)
    }
...
//                        Toast.makeText(this@RecordActivity, R.string.permission_warning, Toast.LENGTH_LONG).show()
//                        setViewVisibility(R.id.showPermissionMsg, View.VISIBLE)
    ...
    private fun saveImage(bytes: ByteArray) {
        ...
        try {
            ...
            outStream.close()
            Toast.makeText(this@RecordActivity, "Picture Saved: $fileName", Toast.LENGTH_LONG).show()
